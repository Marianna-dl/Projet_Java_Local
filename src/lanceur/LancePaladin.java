...
public class LancePaladin {
	...
	public static void main(String[] args) {
		...
		try {
			...
			caracts.put(Caracteristique.INITIATIVE, 60); 
			
			Point position = Calculs.positionAleatoireArene();	
			
			new StrategiePaladin(ipArene, port, ipConsole, "Paladin", "24", caracts, nbTours, position, logger);
