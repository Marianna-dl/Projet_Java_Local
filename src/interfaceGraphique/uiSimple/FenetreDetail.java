...
public class FenetreDetail extends JFrame {
	...
	private void initComposants() {
	    ...
	    Portrait portrait = new Portrait(vue.getColor(), vue.getType() == TypeElement.PERSONNAGE);
		...
		for (Caracteristique caract : Caracteristique.values()) {
			DetailCaracteristique caractPanel = new DetailCaracteristique(caract, vue.getCaract(caract));
