...
public class AreneJPanel extends JPanel {
		...
		/**
		 * Liste de tous les objets connectés à l'interface.
		 */
		private List<VueElement> objets = new ArrayList<VueElement>();
		/**
		 * Liste de tous les personnages connectés à l'interface
		 */
		...
		/**
		 * Couleur du rond entourant les éléments selectionnés
		 */
		private static final Color SELECTED_COLOR = new Color(0,0,0, 70);
		/**
		 * Timer permettant l'affichage du compte à rebours
		 */
		private Timer declencheur;
		/**
		 * Decompte du compte à rebours
		 */
		private int decompte = 5;
		/**
		 * compte à rebours activé ou pas
		 */
		...
		public AreneJPanel() {
			super();
			//Timer d'une seconde permettant l'affichage du compte à rebours
		...
		public void paintComponent(Graphics g) {
			...
			//Affiche le compte à rebours de début de partie
			if (compteARebours) {
		...
		/**
		 * Dessine la représentation d'une VueElement dans le graphics g
		 * @param g destination du dessin
		 * @param vueElement Element à dessiner
		 */
		private void dessinerElement(Graphics g, VueElement vueElement) {
			...
			// Défini la couleur de l'élement
			g.setColor(vueElement.getColor());
			
			// Dessine la représentation géometrique de l'élement
		...
		/**
		 * Dessine la representation geometrique de l'élément
		 * @param g
		 * @param vueElement
		 * @param coordX
		 * @param coordY
		...
		private void drawElementGeometric(Graphics g, VueElement vueElement, int coordX,
			...
			case PERSONNAGE:
				...
				//construis un ovale aux coordonnes coordX, coordY de taille ELEMENT_SIZE x ELEMENT_SIZE
		...
		/**
		 * Ecris le nom de l'élément
		 * @param g Graphics dans lequel ecrire le nom
		 * @param vueElement
		 * @param rect
		 * @param coordX
		 * @param coordY
		 * @return vrai si le texte à été ecris en dessous de la forme représentant l'élément,
		 *  faux sinon
		 */
		...
		/**
		 * Dessine la jauge de vie de l'élément
		 * @param g
		 * @param vueElement
		 * @param rect
		 * @param coordX
		...
		/**
		 * Initialise les VueElement à afficher
		 * @param personnages 
		 * @param objets liste des VueElement à afficher
		 */
		...
		/**
		 * Défini l'affichage ou non des jauges de vie
		 ...
		 * @param coordX
		 * @param coordY
		 * @return polygon correspondant à une couronne
		 */
		 ...
		 * @return polygon correspondant à un triangle
		 */
		...
		/**
		 * Renvoi la position dans l'arène correspondant à une position cliquée sur le panel
		...
		/**
		 * Renvoi la position dans le panel d'une position de l'arène
		 * @param point position dans l'arène
